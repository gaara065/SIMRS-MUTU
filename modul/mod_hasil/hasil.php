...
<div class="content-wrapper">
      ...
      <h1>
<?php
echo ucwords(" data hasil tes STIEP");
?>  
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="row">
  	 ...
  	 <div class="box table-responsive no-padding">
		 ...
		 <a href='media.php?module=hasil'><button type='button' class='btn btn-success style2'><font color='white'>Sudah Bayar </font></button></a>
			     <a href='media.php?module=hasil&act=lulus'><button type='button' class='btn btn-warning style2'><font color='white'>Lulus </font></button></a>
				 <a href='media.php?module=hasil&act=tidak'><button type='button' class='btn btn-info style2'><font color='white'>Tidak Lulus </font></button></a> 
...
$stmt = $db->query("SELECT *
      FROM tbl_user a
        ...
        where b.keterangan='sudah bayar' and a.tujuan='1'
	 ");
...
$stmt = $db->query("SELECT *
      FROM tbl_user a
        inner join tbl_nilai b
        on a.id_user=b.id_user
          where b.keterangan='lulus' and a.tujuan='1'
...
<a href='$aksi?module=hasil&act=bayar&id=$data[id_nilai]&idu=$data[id_user]' class='btn btn-block btn-social btn-dropbox'>
...
$stmt = $db->query("SELECT b.username,b.nama,a.score,a.keterangan ,b.jurusan,b.kelas
      FROM tbl_nilai a
        inner join tbl_user b
        on b.id_user=a.id_user
          where a.keterangan='tidak lulus' and b.tujuan='1'
...
<td>$data[keterangan]</td>
 ...
 ?>  
     ...
     <section class="content">
      ...
      <a href='media.php?module=hasil&act=lulus'><button type='button' class='btn btn-success style2'><font color='white'>Lulus </font></button></a>
            <a href='media.php?module=hasil&act=tidak'><button type='button' class='btn btn-warning style2'><font color='white'>Tidak Lulus </font></button></a>
          <a href='media.php?module=hasil&act=belum'><button type='button' class='btn btn-info style2'><font color='white'>Belum Tes </font></button></a> 
