    ...
    <section class="content">
      ...
      <div class="row">
  	 ...
  	 <div class="box table-responsive no-padding">
			  ...
			  <a href='media.php?module=mapel&act=tambah'><button type='button' class='btn btn-success style2'><font color='white'>Tambah </font></button></a>
...
<td>  
													<a href='media.php?module=mapel&act=ubah&id=$data[id_mapel]' class='btn btn-social-icon btn-bitbucket'><i class='fa fa-edit'></i></a>
											       "; ?>
													
													<a href="<?php echo "$aksi?module=mapel&act=hapus&id=$data[id_mapel]"; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')" class='btn btn-social-icon btn-google'><i class='fa fa-bitbucket'></i></a>
...
<form role="form" method="POST" action='<?php echo"$aksi?module=mapel&act=tambah"; ?>' enctype='multipart/form-data'>
...
$stmt = $db->query("SELECT * FROM  mapel where id_mapel='$_GET[id]'");
...
<form role="form" method="POST" action='<?php echo"$aksi?module=mapel&act=ubah"; ?>' enctype='multipart/form-data'>
	
	
	<input type="hidden" name="id_mapel" value="<?php echo $rowa['id_mapel']; ?>"/>
