    ...
    <section class="content">
      ...
      <div class="row">
  	 ...
  	 <div class="box table-responsive no-padding">
			  ...
			  <a href='media.php?module=guru&act=tambah'><button type='button' class='btn btn-success style2'><font color='white'>Tambah </font></button></a>
...
<td>  
													<a href='media.php?module=guru&act=ubah&id=$data[id_guru]' class='btn btn-social-icon btn-bitbucket'><i class='fa fa-edit'></i></a>
											       "; ?>
													
													<a href="<?php echo "$aksi?module=guru&act=hapus&id=$data[id_guru]"; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')" class='btn btn-social-icon btn-google'><i class='fa fa-bitbucket'></i></a>
...
<form role="form" method="POST" action='<?php echo"$aksi?module=guru&act=tambah"; ?>' enctype='multipart/form-data'>
